...
public class PlanejamentoMapperImpl implements PlanejamentoMapper {
    ...
    protected MateriaEntity materiaDTOToMateriaEntity(MateriaDTO materiaDTO) {
        if ( materiaDTO == null ) {
            return null;
        }
    ...
    protected MateriaPlanejamentoEntity materiaPlanejamentoDTOToMateriaPlanejamentoEntity(MateriaPlanejamentoDTO materiaPlanejamentoDTO) {
        ...
        materiaPlanejamentoEntity.setPlanejamentoEntity( toPlanejamentoEntity( materiaPlanejamentoDTO.getPlanejamentoEntity() ) );
        materiaPlanejamentoEntity.setMateriaEntity( materiaDTOToMateriaEntity( materiaPlanejamentoDTO.getMateriaEntity() ) );
    ...
    protected MateriaDTO materiaEntityToMateriaDTO(MateriaEntity materiaEntity) {
    ...
    protected MateriaPlanejamentoDTO materiaPlanejamentoEntityToMateriaPlanejamentoDTO(MateriaPlanejamentoEntity materiaPlanejamentoEntity) {
        ...
        materiaPlanejamentoDTO.setPlanejamentoEntity( toPlanejamentoDTO( materiaPlanejamentoEntity.getPlanejamentoEntity() ) );
        materiaPlanejamentoDTO.setMateriaEntity( materiaEntityToMateriaDTO( materiaPlanejamentoEntity.getMateriaEntity() ) );
